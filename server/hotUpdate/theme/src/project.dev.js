window.__require = function e(t, n, r) {
  ...
  157: [ function(require, module, exports) {
    (function(name, context, definition) {
      ...
      return function() {
        var input;
        input = "object" === typeof arguments[0] ? arguments[0] : [].slice.call(arguments);
        return normalize(input);
      };
    });
  }, {} ],
  AbstractModel: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "d175cXDBVJGCZ3kOkNR1e0R", "AbstractModel");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var Observer_1 = require("../Observer");
    var PropertyDecorator_1 = require("../PropertyDecorator");
    var AbstractObserverArray_1 = require("./AbstractObserverArray");
    var AbstractModel = function(_super) {
      __extends(AbstractModel, _super);
      function AbstractModel(module, model, observer, context) {
        var _this = _super.call(this) || this;
        _this.listeners = [];
        _this._module = module;
        _this.assign(model, observer, context);
        _this.mutables(_this.constructor["mutables"] || []);
        _this.loaded();
        return _this;
      }
      Object.defineProperty(AbstractModel.prototype, "module", {
        get: function() {
          return this._module;
        },
        enumerable: true,
      ...
      AbstractModel.prototype.addObserver = function(callback, context) {
        var index = this.listeners.findIndex(function(item) {
          return item.compar(callback, context);
        });
        -1 === index && this.listeners.push(new Observer_1.Observer(callback, context, false));
      };
      AbstractModel.prototype.removeObserver = function(callback, context) {
      ...
      AbstractModel.prototype.assign = function(model, observer, context) {
        void 0 === model && (model = {});
        Object.assign(this, model);
        observer && context && this.addObserver(observer, context);
        return this;
      };
      AbstractModel.prototype.mutables = function(keys) {
        var _this = this;
        void 0 === keys && (keys = []);
        keys.forEach(function(key) {
          var value = _this.observable(key, _this[key]);
          Object.defineProperty(_this, key, {
            ...
            set: function(newValue) {
              ...
              value = _this.observable(key, newValue);
              _this.obArray(key, value);
              _this.notify(key, value);
            }
          });
        });
      };
      AbstractModel.prototype.observable = function(key, value) {
        var _this = this;
        this.isObservable(value) && value.addObserver(function(subKey, value) {
          _this.notify(key + "." + subKey, value);
        }, this);
        return value;
      };
      AbstractModel.prototype.notify = function(key, value) {
        this.listeners.forEach(function(observer) {
          return observer.notify(key, value);
        });
      };
      AbstractModel.prototype.isObservable = function(value) {
        return !!(void 0 !== value && value["addObserver"]);
      };
      return AbstractModel;
    }(AbstractObserverArray_1.default);
    exports.default = AbstractModel;
    exports.Mutable = PropertyDecorator_1.PropertyDecorator.bind(null, "mutables");
    cc._RF.pop();
  }, {
    "../Observer": "Observer",
    "../PropertyDecorator": "PropertyDecorator",
    "./AbstractObserverArray": "AbstractObserverArray"
  } ],
  AbstractModule: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "db17eqsrHZF+KyJSda0xRcY", "AbstractModule");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var Notify_1 = require("../../cores/Notify");
    var SceneManager_1 = require("../../singles/SceneManager");
    var Runtime_1 = require("../../singles/Runtime");
    var ccclass = cc._decorator.ccclass;
    var AbstractModule = function(_super) {
      ...
      function AbstractModule() {
        ...
        _this.viewModels = {};
        false;
        Notify_1.default.instance.on(SceneManager_1.default.SCENE_EVENT_MAIN, SceneManager_1.default.SCENE_EVENT_LOAD_DONE, _this.loadSceneDone, _this);
        return _this;
      }
      Object.defineProperty(AbstractModule.prototype, "name", {
        get: function() {
      ...
      AbstractModule.prototype.loadSceneDone = function(data) {
      ...
      Object.defineProperty(AbstractModule.prototype, "modulePath", {
        get: function() {
          var dirname = Runtime_1.default.instance.isSubpackage(this.name) ? "subModules" : "mainModules";
          return cc.path.join(dirname, this.name);
        },
        enumerable: true,
        configurable: true
      });
      Object.defineProperty(AbstractModule.prototype, "layoutPath", {
        get: function() {
          var modConfig = Runtime_1.default.instance.getModule(this.name);
          if (!!modConfig) return cc.path.join(this.modulePath, "layouts", modConfig.layout);
          return "";
        },
        enumerable: true,
        configurable: true
      });
      Object.defineProperty(AbstractModule.prototype, "skinPath", {
        get: function() {
          var modConfig = Runtime_1.default.instance.getModule(this.name);
          if (!!modConfig) return cc.path.join(this.layoutPath, "skins", modConfig.skin);
          return "";
        },
        enumerable: true,
        configurable: true
      });
      AbstractModule.prototype.getViewModel = function(viewModel, md5) {
        this.viewModels[md5] || (this.viewModels[md5] = new viewModel(this));
        return this.viewModels[md5];
      };
      AbstractModule.prototype.getModel = function(model, md5, data, observer, context) {
        if (!this.models[md5]) {
      ...
      AbstractModule.prototype.destroyMVVM = function() {
        if (this.isDontDestroy) return;
        for (var key in this.viewModels) if (this.viewModels.hasOwnProperty(key)) {
          var viewModel = this.viewModels[key];
          viewModel.destroy();
        }
        this.viewModels = {};
        for (var key in this.models) if (this.models.hasOwnProperty(key)) {
          var model = this.models[key];
          model.destroy();
        }
        this.models = {};
      };
      AbstractModule = __decorate([ ccclass ], AbstractModule);
      return AbstractModule;
    }(cc.Component);
    exports.default = AbstractModule;
    function Module(moduleName, isDontDestroy) {
      var f = function() {
        var args = [];
        ...
        args[0].prototype.notify = new Notify_1.default(moduleName);
      };
      return f;
    }
    ...
    "../../cores/Notify": "Notify",
    "../../singles/Runtime": "Runtime",
    "../../singles/SceneManager": "SceneManager"
  } ],
  AbstractObservable: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "75434LDc6hHvIdn0E2FyR6c", "AbstractObservable");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var Observer_1 = require("../Observer");
    var AbstractObservable = function() {
      ...
      AbstractObservable.prototype.isObservable = function(value) {
        return !!(void 0 !== value && value["addObserver"]);
      };
      AbstractObservable.prototype.addObserver = function(callback, context) {
        var index = this.listeners.findIndex(function(item) {
          return item.compar(callback, context);
        });
        -1 === index && this.listeners.push(new Observer_1.Observer(callback, context, false));
      };
      AbstractObservable.prototype.removeObserver = function(callback, context) {
        for (var i = 0; i < this.listeners.length; i++) {
          var listener = this.listeners[i];
          if (listener.compar(callback, context)) {
            this.listeners.splice(i, 1);
      ...
      AbstractObservable.prototype.notify = function() {
        var params = [];
        for (var _i = 0; _i < arguments.length; _i++) params[_i] = arguments[_i];
        this.listeners.forEach(function(observer) {
          return observer.notify(params[0], params[1]);
        });
      };
  ...
  AbstractObserverArray: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "4d57elPqeVIRqujAmuII+pK", "AbstractObserverArray");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var AbstractObserverArray = function() {
      function AbstractObserverArray() {}
      AbstractObserverArray.prototype.obArray = function(key, value) {
        return;
      };
      AbstractObserverArray.prototype.observerObject = function(key, originValue, value) {
        var _this = this;
        if (!value) return;
        Object.keys(value).forEach(function(k) {
          Array.isArray(value[k]) ? _this.observerArray(key, originValue, value[k]) : "object" === typeof value[k] && _this.observerObject(key, originValue, value[k]);
        });
      };
      AbstractObserverArray.prototype.observerArray = function(key, originValue, value) {
        ...
        if (Array.isArray(value)) {
          ...
          Object.getOwnPropertyNames(origin).forEach(function(name) {
            methods.includes(name) || (value["__proto__"][name] = Array.prototype[name]);
          });
          return true;
        }
      };
      return AbstractObserverArray;
    }();
    exports.default = AbstractObserverArray;
    cc._RF.pop();
  }, {} ],
  AbstractViewModel: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "462e1ZG7PtDgJe970JKxnBF", "AbstractViewModel");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var AbstractObserverArray_1 = require("./AbstractObserverArray");
    var Observer_1 = require("../Observer");
    var PropertyDecorator_1 = require("../PropertyDecorator");
    var Facade_1 = require("../../cores/Facade");
    var Utils_1 = require("../../tools/Utils");
    var AbstractViewModel = function(_super) {
      __extends(AbstractViewModel, _super);
      function AbstractViewModel(module) {
        var _this = _super.call(this) || this;
        _this.propagation = true;
        _this.bindListener = {};
        _this.commandListener = {};
        false;
        _this._module = module;
        _this._model = _this.module.getModel(_this.model, _this.modelName, _this.injectHandler(), _this.observer, _this);
        _this.commands(_this.constructor["commands"] || []);
        _this.bindables(_this.constructor["bindables"] || []);
        _this.loaded();
        return _this;
      }
      Object.defineProperty(AbstractViewModel.prototype, "module", {
        get: function() {
          return this._module;
        },
        enumerable: true,
      ...
      Object.defineProperty(AbstractViewModel.prototype, "model", {
        get: function() {
          return this._model;
        },
        enumerable: true,
      ...
      AbstractViewModel.prototype.bind = function(key, callback, context) {
        var parent = this.getDescriptor(key);
        parent ? this.cascade(key, parent) : this.define(key);
        this.bindListener[key] || (this.bindListener[key] = []);
        var observer = new Observer_1.Observer(callback, context, false);
        observer.notify(this[key]);
        this.bindListener[key].push(observer);
        return this;
      };
      AbstractViewModel.prototype.unbind = function(key, callback, context) {
        var observers = this.bindListener[key];
        if (observers) for (var i = 0; i < observers.length; i++) {
      ...
      AbstractViewModel.prototype.unbindAll = function(context) {
        for (var key in this.bindListener) if (this.bindListener.hasOwnProperty(key)) {
          var observers = this.bindListener[key];
      ...
      AbstractViewModel.prototype.on = function(command, callback, context) {
        this.commandListener[command] || (this.commandListener[command] = []);
        this.commandListener[command].push(new Observer_1.Observer(callback, context, false));
        return this;
      };
      AbstractViewModel.prototype.off = function(command, callback, context) {
      ...
      AbstractViewModel.prototype.offAll = function(context) {
        for (var key in this.commandListener) if (this.commandListener.hasOwnProperty(key)) {
          var observers = this.commandListener[key];
          for (var i = 0; i < observers.length; i++) {
            var observer = observers[i];
            if (observer.compar(null, context)) {
              observers.splice(i, 1);
      ...
      AbstractViewModel.prototype.destroy = function() {
        this.model.removeObserver(this.observer, this);
        this.injectModel && this.injectModel.removeObserver(this.oberverInject, this);
        this.bindListener = {};
        this.commandListener = {};
        this.unload();
      };
      AbstractViewModel.prototype.oberverInject = function(key, value) {
        this.model[key] = value;
        this[key] = value;
      };
      AbstractViewModel.prototype.observer = function(key, value) {
        if (!this.propagation) return;
        (this.constructor["bindables"] || []).includes(key) && (this[key] = value);
      };
      AbstractViewModel.prototype.cascade = function(key, parent) {
        var _this = this;
        ...
        Object.defineProperty(this, key, {
          ...
          set: function(value) {
            if (parent.set) {
              _this.propagation = false;
              parent.set.call(_this, value);
              _this.propagation = true;
            }
            _this.notify(key, value);
          },
      ...
      AbstractViewModel.prototype.define = function(key) {
        var _this = this;
        if (this.bindListener[key]) return;
        var value = this[key];
      ...
      AbstractViewModel.prototype.commands = function(keys) {
        var _this = this;
        void 0 === keys && (keys = []);
        keys.forEach(function(property) {
          _this[property] = function() {
            ...
            for (var _i = 0; _i < arguments.length; _i++) params[_i] = arguments[_i];
            var _a;
            var result = (_a = Object.getPrototypeOf(_this)[property]).apply.apply(_a, [ _this ].concat(params));
            (_this.commandListener[property] || []).forEach(function(listener) {
              var _a;
              listener.notify((_a = [ _this ]).concat.apply(_a, params));
            });
            return result;
          };
        });
      };
      AbstractViewModel.prototype.bindables = function(keys) {
        var _this = this;
        void 0 === keys && (keys = []);
        keys.forEach(function(key) {
          var parent = _this.getDescriptor(key);
          parent || Object.defineProperty(_this, key, {
            get: function() {
      ...
      AbstractViewModel.prototype.getDescriptor = function(key) {
        var object = this, descriptor;
        do {
      ...
      AbstractViewModel.prototype.notify = function(key, value) {
        var observers = this.bindListener[key];
        if (!observers) return;
        observers.forEach(function(observer) {
          return observer.notify(value);
        });
      };
      AbstractViewModel.prototype.injectHandler = function() {
        var _this = this;
        var injectData = {};
        try {
          if (this.inject) {
            this.injectModel = Facade_1.default.getModule(this.inject.module).getModel(this.inject.model, this.inject.modelName);
            if (this.injectModel) {
              var bindables = this.constructor["injectbinds"] || [];
              bindables.forEach(function(field) {
                if (_this.injectModel.hasOwnProperty(field)) {
                  injectData[field] = _this.injectModel[field];
                  _this[field] = _this.injectModel[field];
                }
              });
    ...
    exports.Bindable = PropertyDecorator_1.PropertyDecorator.bind(null, "bindables");
    exports.Command = PropertyDecorator_1.PropertyDecorator.bind(null, "commands");
    exports.InjectBind = PropertyDecorator_1.PropertyDecorator.bind(null, "injectbinds");
    function Model(model) {
      var f = function() {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) args[_i] = arguments[_i];
        args[0].prototype.modelName = Utils_1.default.md5String(model.toString());
        false;
    ...
    function Inject(module, model) {
      var f = function() {
        ...
        args[0].prototype.inject = {
          module: module,
          model: model,
          modelName: Utils_1.default.md5String(model.toString())
        };
      };
      return f;
    }
  ...
  AbstractView: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "994a0BiTQRPaYmHMQa1oxWJ", "AbstractView");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var PropertyDecorator_1 = require("../PropertyDecorator");
    ...
    var AbstractView = function(_super) {
      ...
      function AbstractView() {
        var _this = _super.call(this) || this;
        _this._isBindings = false;
        if (false, !_this.moduleName) return _this;
        _this._module = Facade_1.default.getModule(_this.moduleName);
        if (!_this.module) return _this;
        if (!_this.viewModel) return _this;
        _this.viewModel = _this.module.getViewModel(_this.viewModel, _this.viewModelName);
        _this.ackOnLoad();
        _this.ackOnDestroy();
        return _this;
      }
      Object.defineProperty(AbstractView.prototype, "module", {
        get: function() {
          return this._module;
        },
        enumerable: true,
      ...
      AbstractView.prototype.commands = function(keys) {
        var _this = this;
        void 0 === keys && (keys = []);
        keys.forEach(function(key) {
          return _this[key] = function() {
            var params = [];
            for (var _i = 0; _i < arguments.length; _i++) params[_i] = arguments[_i];
            _this.viewModel[key] && _this.viewModel[key](params);
          };
        });
      };
      AbstractView.prototype.bindings = function(keys) {
        var _this = this;
        void 0 === keys && (keys = []);
        if (this._isBindings) return;
        keys.forEach(function(key) {
          _this.viewModel.bind(key, _this[key], _this);
        });
        this._isBindings = true;
      };
      AbstractView.prototype.ackOnLoad = function() {
        var _this = this;
        var originOnLoad = this.onLoad;
        this.onLoad = function() {
          originOnLoad && originOnLoad.apply(_this);
          _this.commands(_this.constructor["commands"] || []);
          _this.restoreBindings();
        };
      };
      AbstractView.prototype.unbindings = function(keys) {
        var _this = this;
        void 0 === keys && (keys = []);
        if (!this._isBindings) return;
        keys.forEach(function(key) {
          _this.viewModel.unbind(key, _this[key], _this);
        });
        this._isBindings = false;
      };
      AbstractView.prototype.ackOnDestroy = function() {
        var _this = this;
        var originOnDestroy = this.onDestroy;
        this.onDestroy = function() {
          _this.module.notify.offContext(_this);
          Notify_1.default.instance.offContext(_this);
          _this.viewModel && _this.viewModel.unbindAll(_this).offAll(_this);
          originOnDestroy && originOnDestroy.apply(_this);
        };
      };
      AbstractView.prototype.restoreBindings = function() {
        this.bindings(this.constructor["bindings"] || []);
        this.bindings(this.constructor["injectbinds"] || []);
      };
      AbstractView.prototype.pauseBindings = function() {
        this.unbindings(this.constructor["bindings"] || []);
        this.unbindings(this.constructor["injectbinds"] || []);
      };
      AbstractView.prototype.set = function(property, value) {
        this.viewModel[property] = value;
      };
      AbstractView.prototype.get = function(property) {
        return this.viewModel[property];
      };
      AbstractView.prototype.bind = function(key, callback) {
        this.viewModel.bind(key, callback, this);
      };
      AbstractView.prototype.unbind = function(key, callback) {
        this.viewModel.unbind(key, callback, this);
      };
      AbstractView.prototype.unbindAll = function() {
        this.viewModel.unbindAll(this);
      };
      AbstractView.prototype.on = function(command, callback) {
        this.viewModel.on(command, callback, this);
      };
      AbstractView.prototype.off = function(command, callback) {
        this.viewModel.off(command, callback, this);
      };
      AbstractView.prototype.offAll = function() {
        this.viewModel.offAll(this);
      };
      AbstractView = __decorate([ ccclass ], AbstractView);
      return AbstractView;
    }(cc.Component);
    exports.default = AbstractView;
    exports.Binding = PropertyDecorator_1.PropertyDecorator.bind(null, "bindings");
    function ViewModel(moduleName, viewModel, autoInjectCommands) {
      var f = function() {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) args[_i] = arguments[_i];
        if (autoInjectCommands) {
          ...
          for (var i = 0; i < commands.length; i++) {
            ...
            args[0].prototype[command] = function() {
              var params = [];
              for (var _i = 0; _i < arguments.length; _i++) params[_i] = arguments[_i];
            };
          }
        }
        args[0].prototype.viewModelName = Utils_1.default.md5String(viewModel.toString());
        false;
        args[0].prototype.moduleName = moduleName;
  ...
  Audio: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "bb4ddFUssZLI722jOTX2bli", "Audio");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var Audio = function() {
  ...
  Company: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "62ca7VpjalFFYkKD/Uw0PCg", "Company");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var Utils_1 = require("../tools/Utils");
    var Company = function() {
      ...
      Object.defineProperty(Company, "instance", {
        get: function() {
          null === this._instance && (this._instance = new Company());
      ...
      Object.defineProperty(Company.prototype, "template", {
        get: function() {
      ...
      Object.defineProperty(Company.prototype, "serverHost", {
        get: function() {
      ...
      Object.defineProperty(Company.prototype, "hotUpdateUrl", {
        get: function() {
      ...
      Object.defineProperty(Company.prototype, "developmentModel", {
        get: function() {
      ...
      Object.defineProperty(Company.prototype, "package", {
        get: function() {
      ...
      Object.defineProperty(Company.prototype, "app_id", {
        get: function() {
      ...
      Object.defineProperty(Company.prototype, "app_secret", {
        get: function() {
        ...
        return __awaiter(this, void 0, Promise, function() {
          ...
          return __generator(this, function(_a) {
            return [ 2, new Promise(function(resolve, reject) {
              Utils_1.default.isHotUpdate ? _this.loadLocal().then(resolve).catch(reject) : cc.loader.loadRes("company", cc.Asset, function(err, res) {
                if (err) return reject(err);
                _this.company = res.json;
                return resolve(_this.company);
              });
            }) ];
          });
        });
      };
      Company.prototype.loadLocal = function() {
        var _this = this;
        return new Promise(function(resolve, reject) {
          if (null == _this.company) {
            var company_path = "./res/company.json";
            if (!jsb.fileUtils.isFileExist(company_path)) return reject("\u627e\u4e0d\u5230\u539f\u59cb " + company_path + " \u914d\u7f6e\u6587\u4ef6");
            var str = jsb.fileUtils.getStringFromFile(company_path);
            _this.company = JSON.parse(str);
            resolve(_this.company);
          } else resolve(_this.company);
        });
      };
  ...
  Facade: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "81401bv/DBBUZg2xPMlt6fN", "Facade");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var Facade = function() {
      function Facade() {}
      Facade.getModule = function(name) {
        try {
          if (!Facade.modules[name]) {
            var moduleNode = new cc.Node(name);
            var moduleScript = moduleNode.addComponent(name);
  ...
  Interface: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "3526fRUz8pBpagVn3HqMoZW", "Interface");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    cc._RF.pop();
  }, {} ],
  ModuleUpdate: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "64195cHmHdPg5ruRgySw7Zz", "ModuleUpdate");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var Utils_1 = require("../tools/Utils");
    var Facade_1 = require("../cores/Facade");
    var Update_1 = require("../cores/Update");
    ...
    var UpdateTask = function() {
      ...
      UpdateTask.prototype.checkUpdate = function() {
        return __awaiter(this, void 0, Promise, function() {
          var _this = this;
          return __generator(this, function(_a) {
            return [ 2, new Promise(function(resolve, reject) {
              return __awaiter(_this, void 0, void 0, function() {
                var _this = this;
                return __generator(this, function(_a) {
                  if (this.isStartup) return [ 2, resolve(false) ];
                  if (!this.isInstalled) return [ 2, resolve(true) ];
                  this.hotUpdate = new Update_1.default(this.name);
                  this.hotUpdate.checkUpdate().then(function(isUpdate) {
                    return __awaiter(_this, void 0, void 0, function() {
                      return __generator(this, function(_a) {
                        switch (_a.label) {
                         case 0:
                          if (!!isUpdate) return [ 3, 2 ];
                          return [ 4, this.startup() ];
      ...
      UpdateTask.prototype.install = function(progressEvent) {
        return __awaiter(this, void 0, Promise, function() {
          var _this = this;
          return __generator(this, function(_a) {
            return [ 2, new Promise(function(resolve, reject) {
              return __awaiter(_this, void 0, void 0, function() {
                ...
                return __generator(this, function(_a) {
                  if (this.isStartup) return [ 2, resolve(false) ];
                  this.hotUpdate = new Update_1.default(this.name);
                  this.isInstalled ? this.hotUpdate.startUpdate(progressEvent).then(function(isRestart) {
                    _this.startup().then(function() {
                      resolve(isRestart);
                    }).catch(reject);
                  }).catch(reject) : this.hotUpdate.install(progressEvent).then(function() {
                    _this.startup().then(resolve).catch(reject);
                  }).catch(reject);
                  return [ 2 ];
                });
              });
      ...
      UpdateTask.prototype.startup = function() {
        var _this = this;
        return new Promise(function(resolve, reject) {
          if (!_this.name || _this.isStartup) {
            resolve();
            return;
          }
          if (false, Runtime_1.default.instance.isSubpackage(_this.name)) cc.loader.downloader.loadSubpackage(_this.name, function(err) {
            if (err) {
              cc.error(err);
              return reject();
            }
            Facade_1.default.getModule(_this.name);
            _this.isStartup = true;
            resolve(true);
          }); else {
            Facade_1.default.getModule(_this.name);
            _this.isStartup = true;
      ...
      Object.defineProperty(UpdateTask.prototype, "isInstalled", {
        get: function() {
          if (!Utils_1.default.isHotUpdate) return true;
          if (!this.name) return true;
          if (!Runtime_1.default.instance.isSubpackage(this.name)) return true;
          var modulePath = cc.path.join(jsb.fileUtils.getWritablePath(), "remote-assets/subpackages", this.name, "index.js");
    ...
    var ModuleUpdate = function() {
      ...
      Object.defineProperty(ModuleUpdate, "instance", {
        get: function() {
          null === this._instance && (this._instance = new ModuleUpdate());
          return this._instance;
        },
        enumerable: true,
        configurable: true
      });
      ModuleUpdate.prototype.getTask = function(name) {
      ...
      ModuleUpdate._instance = null;
      return ModuleUpdate;
    }();
    exports.default = ModuleUpdate;
    cc._RF.pop();
  }, {
    "../cores/Facade": "Facade",
    "../cores/Update": "Update",
  ...
  Notify: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "db938YV7flARpv5NQR7DZe1", "Notify");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var Observer_1 = require("../abstract/Observer");
    ...
    var Notify = function() {
      ...
      Object.defineProperty(Notify, "instance", {
        get: function() {
          null === this._instance && (this._instance = new Notify("fromework"));
          return this._instance;
        },
        enumerable: true,
        configurable: true
      });
      Notify.prototype.on = function(main, sub, callback, context, once) {
        if (!callback) return;
        this.listeners[main] || (this.listeners[main] = {});
        this.listeners[main][sub] || (this.listeners[main][sub] = []);
        this.listeners[main][sub].push(new Observer_1.Observer(callback, context, once));
      };
      Notify.prototype.emitModuleReturn = function(moduleName, main, sub) {
        var args = [];
        for (var _i = 3; _i < arguments.length; _i++) args[_i - 3] = arguments[_i];
        return __awaiter(this, void 0, Promise, function() {
          var _a, module;
          return __generator(this, function(_b) {
            module = Facade_1.default.getModule(moduleName);
            if (!module) return [ 2, void 0 ];
            return [ 2, (_a = module.notify).emitReturn.apply(_a, [ main, sub ].concat(args)) ];
          });
        });
      };
      Notify.prototype.emitModule = function(moduleName, main, sub) {
        var args = [];
        for (var _i = 3; _i < arguments.length; _i++) args[_i - 3] = arguments[_i];
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_b) {
            module = Facade_1.default.getModule(moduleName);
            if (!module) return [ 2 ];
            return [ 2, (_a = module.notify).emit.apply(_a, [ main, sub ].concat(args)) ];
          });
        });
      };
      Notify.prototype.emitModuleSync = function(moduleName, main, sub) {
        var args = [];
        for (var _i = 3; _i < arguments.length; _i++) args[_i - 3] = arguments[_i];
        var _a;
        var module = Facade_1.default.getModule(moduleName);
        if (!module) return;
        (_a = module.notify).emitSync.apply(_a, [ main, sub ].concat(args));
      };
      Notify.prototype.once = function(main, sub, callback, context) {
        this.on(main, sub, callback, context, true);
      };
      Notify.prototype.emitReturn = function(main, sub) {
        var args = [];
        for (var _i = 2; _i < arguments.length; _i++) args[_i - 2] = arguments[_i];
        return __awaiter(this, void 0, Promise, function() {
          var observers, i, observer, result;
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              observers = this.getObservers(main, sub);
              if (!observers) return [ 2, Promise.resolve(void 0) ];
              i = 0;
              _a.label = 1;

             case 1:
              if (!(i < observers.length)) return [ 3, 4 ];
              observer = observers[i];
              return [ 4, observer.notify.apply(observer, args).catch(cc.error) ];
      ...
      Notify.prototype.emit = function(main, sub) {
        var args = [];
        for (var _i = 2; _i < arguments.length; _i++) args[_i - 2] = arguments[_i];
        return __awaiter(this, void 0, void 0, function() {
          var observers, i, observer;
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              observers = this.getObservers(main, sub);
              if (!observers) return [ 2 ];
              i = 0;
              _a.label = 1;
      ...
      Notify.prototype.emitContext = function(context, main, sub) {
        var args = [];
        for (var _i = 3; _i < arguments.length; _i++) args[_i - 3] = arguments[_i];
        return __awaiter(this, void 0, void 0, function() {
          var observers, i, observer;
          return __generator(this, function(_a) {
            switch (_a.label) {
             ...
             case 1:
              if (!(i < observers.length)) return [ 3, 4 ];
              observer = observers[i];
              if (!observer.compar(null, context)) return [ 3, 3 ];
              return [ 4, observer.notify.apply(observer, args).catch(cc.error) ];
      ...
      Notify.prototype.emitSync = function(main, sub) {
        var args = [];
        for (var _i = 2; _i < arguments.length; _i++) args[_i - 2] = arguments[_i];
      ...
      Notify.prototype.off = function(main, sub, callback, context) {
        if (!this.listeners[main]) return;
        if (!this.listeners[main][sub]) return;
        var observers = this.listeners[main][sub];
        if (!observers) return;
        var index = observers.findIndex(function(observer) {
          return observer.compar(callback, context);
        });
        -1 !== index && observers.splice(index, 1);
        0 === observers.length && delete this.listeners[main][sub];
      };
      Notify.prototype.offMain = function(main) {
        if (!this.listeners[main]) return;
        delete this.listeners[main];
      };
      Notify.prototype.offSub = function(main, sub) {
        if (!this.listeners[main]) return;
        return delete this.listeners[main][sub];
      };
      Notify.prototype.offContext = function(context) {
        for (var main in this.listeners) if (this.listeners.hasOwnProperty(main)) {
          var subs = this.listeners[main];
          for (var key in subs) if (subs.hasOwnProperty(key)) {
            var observers = subs[key];
            for (var i = 0; i < observers.length; i++) {
              var observer = observers[i];
              if (observer.compar(null, context)) {
                observers.splice(i, 1);
      ...
      Notify.prototype.getObservers = function(main, sub) {
        if (!this.listeners[main]) return;
        var observers = this.listeners[main][sub];
        if (!observers) return;
        return observers;
  ...
  Observer: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "c2b37wC3VRF5oV/iut+6iTB", "Observer");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var Observer = function() {
      function Observer(callback, context, once) {
        this.callback = null;
        this.context = null;
        this.once = false;
      ...
      Object.defineProperty(Observer.prototype, "isOnce", {
        get: function() {
          return this.once;
        },
        enumerable: true,
      ...
      Observer.prototype.notify = function() {
        ...
        return __awaiter(this, void 0, void 0, function() {
          var _a;
          return __generator(this, function(_b) {
            return [ 2, (_a = this.callback).call.apply(_a, [ this.context ].concat(args)) ];
          });
        });
      };
      Observer.prototype.compar = function(callback, context) {
        return callback ? context == this.context && callback == this.callback : context == this.context;
      };
      return Observer;
    }();
  ...
  PropertyDecorator: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "235cduCMwlMl5LvKCxrgyCR", "PropertyDecorator");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    function PropertyDecorator(name, type, property) {
      type.constructor.hasOwnProperty(name) || (type.constructor[name] = [].concat(Object.getPrototypeOf(type).constructor[name] || []));
      -1 === type.constructor[name].indexOf(property) && type.constructor[name].push(property);
    }
  ...
  Runtime: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "d13890xINtAm6mi8C2I3i99", "Runtime");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var Runtime = function() {
      function Runtime() {
        this.DEFAULT_LAYOUT = "layout_0";
        this.DEFAULT_SKIN = "skin_0";
        this.DEFAULT_VERSION = "skin_0";
        this.runtime = null;
      }
      Object.defineProperty(Runtime, "instance", {
        get: function() {
          null === this._instance && (this._instance = new Runtime());
          return this._instance;
        },
        enumerable: true,
        configurable: true
      ...
      Runtime.prototype.load = function() {
        var _this = this;
        return new Promise(function(resolve, reject) {
          _this.runtime ? resolve(_this.runtime) : cc.loader.loadRes("runtime", cc.JsonAsset, function(err, res) {
            if (err) return reject(err);
            _this.runtime = res.json;
            resolve(_this.runtime);
          });
        });
      };
      Object.defineProperty(Runtime.prototype, "template", {
        get: function() {
          if (this.runtime) return this.runtime.template;
          return "";
        },
        enumerable: true,
        configurable: true
      });
      Runtime.prototype.getModule = function(moduleName) {
        if (!!this.runtime && !!this.runtime.modules[moduleName]) return this.runtime.modules[moduleName];
        return null;
      };
      Runtime.prototype.getLayout = function(moduleName) {
        var mod = this.getModule(moduleName);
        return !mod ? this.DEFAULT_LAYOUT : mod.layout;
      };
      Runtime.prototype.getSkin = function(moduleName) {
        var mod = this.getModule(moduleName);
        return !mod ? this.DEFAULT_SKIN : mod.skin;
      };
      Runtime.prototype.getVersion = function(moduleName) {
        var mod = this.getModule(moduleName);
        return !mod ? this.DEFAULT_VERSION : mod.version;
      };
      Runtime.prototype.isSubpackage = function(moduleName) {
        var mod = this.getModule(moduleName);
        return !mod || mod.isSubpackage;
      };
  ...
  SceneManager: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "ce4c0Gw399Pqo+qfNdrhG6i", "SceneManager");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var Notify_1 = require("../cores/Notify");
    ...
    var SceneManager = function() {
      ...
      Object.defineProperty(SceneManager, "instance", {
        get: function() {
          null == this._instance && (this._instance = new SceneManager());
          return this._instance;
        },
        enumerable: true,
        configurable: true
      });
      Object.defineProperty(SceneManager.prototype, "currModule", {
        get: function() {
      ...
      Object.defineProperty(SceneManager.prototype, "currScene", {
        get: function() {
      ...
      SceneManager.prototype.loadScene = function(moduleName, scene, progressCallback, loadDoneCallback) {
        return __awaiter(this, void 0, void 0, function() {
          var _this = this;
          return __generator(this, function(_a) {
            if (this.isLoading) return [ 2, cc.warn("\u540c\u65f6\u53ea\u80fd\u8df3\u8f6c\u4e00\u4e2a\u573a\u666f", scene, "\u8df3\u8f6c\u5931\u8d25") ];
            if (this._currModule == moduleName && this._currScene == scene) return [ 2, cc.warn("\u5f53\u524d\u573a\u666f", scene) ];
            this.isLoading = true;
            Notify_1.default.instance.emit("loadScene", "over");
            Notify_1.default.instance.emit(SceneManager.SCENE_EVENT_MAIN, SceneManager.SCENE_EVENT_LOAD_BEFOR, {
              fromModule: this._currModule,
              fromScene: this._currScene,
              toModule: moduleName,
              toScene: scene
            });
            if (!cc.sys.isNative) return [ 2, this.preloadScene(moduleName, scene, progressCallback, loadDoneCallback) ];
            if (!Runtime_1.default.instance.isSubpackage(moduleName)) return [ 2, this.preloadScene(moduleName, scene, progressCallback, loadDoneCallback) ];
            cc.loader.downloader.loadSubpackage(moduleName, function(err) {
              if (err) return cc.error(err);
              return _this.preloadScene(moduleName, scene, progressCallback, loadDoneCallback);
            });
            return [ 2 ];
          });
        });
      };
      SceneManager.prototype.preloadScene = function(moduleName, scene, progressCallback, loadDoneCallback) {
        var _this = this;
        cc.director.preloadScene(scene, function(completedCount, totalCount, item) {
          var speed = completedCount / totalCount;
          var per = Math.floor(100 * completedCount / totalCount);
          progressCallback && progressCallback(speed, per);
        }, function(err) {
          cc.director.loadScene(scene, function() {
            _this.isLoading = false;
            loadDoneCallback && loadDoneCallback();
            Notify_1.default.instance.emit(SceneManager.SCENE_EVENT_MAIN, SceneManager.SCENE_EVENT_LOAD_DONE, {
              fromModule: _this._currModule,
              fromScene: _this._currScene,
              toModule: moduleName,
              toScene: scene
            });
            _this._currModule = moduleName;
            _this._currScene = scene;
          });
        });
      };
      SceneManager.SCENE_EVENT_MAIN = "SCENE_EVENT_MAIN";
      SceneManager.SCENE_EVENT_LOAD_BEFOR = "SCENE_EVENT_LOAD_BEFOR";
      SceneManager.SCENE_EVENT_LOAD_DONE = "SCENE_EVENT_LOAD_DONE";
  ...
  Sprite: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "2bcedgi7/VHVrExtSH4SiKm", "Sprite");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var Sprite = function() {
  ...
  Text: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "e533dpc+atBYYGoa4RUppFq", "Text");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var Text = function() {
  ...
  UILocalizedAudio: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "c1ed8TrscNEn6H8oNNSYbZW", "UILocalizedAudio");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var Audio_1 = require("../../languages/Audio");
    var i18n_1 = require("../../languages/i18n");
    var Runtime_1 = require("../singles/Runtime");
    var Notify_1 = require("../cores/Notify");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property, menu = _a.menu, inspector = _a.inspector, executeInEditMode = _a.executeInEditMode;
    var UILocalizedAudio = function(_super) {
      __extends(UILocalizedAudio, _super);
      function UILocalizedAudio() {
        var _this = _super.call(this) || this;
        _this._key = "";
        false;
        Notify_1.default.instance.on("__i18n__", "refresh", _this.refresh, _this);
        return _this;
      }
      Object.defineProperty(UILocalizedAudio.prototype, "key", {
        get: function() {
          return this._key;
        },
        set: function(value) {
          ...
          this._key = value;
          this.key !== oldKey && this.setAudio(value);
        },
        enumerable: true,
        configurable: true
      });
      UILocalizedAudio.prototype.setAudio = function(key) {
        return __awaiter(this, void 0, void 0, function() {
          var module, dirname, modulePath, audioPath;
          var _this = this;
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              if (!Audio_1.default[key]) return [ 3, 2 ];
              return [ 4, Runtime_1.default.instance.load().catch(cc.error) ];

             case 1:
              _a.sent();
              module = Audio_1.default[key].module;
              dirname = Runtime_1.default.instance.isSubpackage(module) ? "subModules" : "mainModules";
              modulePath = cc.path.join(dirname, module);
              audioPath = cc.path.join(modulePath, "layouts", Runtime_1.default.instance.getLayout(module), "skins", Runtime_1.default.instance.getSkin(module), Audio_1.default[key][i18n_1.i18n.language]);
              cc.loader.loadRes(audioPath, cc.AudioClip, function(err, result) {
                if (err) return cc.error(err);
                _this.clip = result;
              });
              return [ 3, 3 ];
      ...
      UILocalizedAudio.prototype.onFocusInEditor = function() {
        this.refresh();
      };
      UILocalizedAudio.prototype.onEnable = function() {
        _super.prototype.onEnable.call(this);
        this.setAudio(this.key);
      };
      UILocalizedAudio.prototype.onDestroy = function() {
        _super.prototype.onDestroy.call(this);
        Notify_1.default.instance.offContext(this);
      };
      UILocalizedAudio.prototype.refresh = function() {
        if (!this.key) return;
        this.setAudio(this.key);
      };
      __decorate([ property ], UILocalizedAudio.prototype, "_key", void 0);
      __decorate([ property ], UILocalizedAudio.prototype, "key", null);
      UILocalizedAudio = __decorate([ ccclass, menu("UI\u6269\u5c55/\u591a\u8bed\u8a00/UILocalizedAudio"), executeInEditMode ], UILocalizedAudio);
      return UILocalizedAudio;
    }(cc.AudioSource);
    exports.default = UILocalizedAudio;
    cc._RF.pop();
  }, {
  ...
  UILocalizedLabel: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "a2556Xy665L8bj0fFDQhqxe", "UILocalizedLabel");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var Notify_1 = require("../cores/Notify");
    var Text_1 = require("../../languages/Text");
    var i18n_1 = require("../../languages/i18n");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property, menu = _a.menu, inspector = _a.inspector;
    var OUTLINE_SUPPORTED = cc.js.isChildClassOf(cc.LabelOutline, cc.Component);
    var UILocalizedLabel = function(_super) {
      __extends(UILocalizedLabel, _super);
      function UILocalizedLabel() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this.__params = [];
        _this.shareLabelInfo = {
          fontAtlas: null,
          fontFamily: "",
          fontDesc: "Arial",
          fontSize: 0,
      ...
      Object.defineProperty(UILocalizedLabel.prototype, "key", {
        get: function() {
          return this._key;
        },
        set: function(value) {
          ...
          this._key = value;
          Text_1.default[value] && this.setString(value);
        },
        enumerable: true,
        configurable: true
      });
      Object.defineProperty(UILocalizedLabel.prototype, "keyBlur", {
        set: function(a) {
          if (this._key && !Text_1.default[this._key]) {
            this.key = "";
            this.setString("");
          }
        },
      ...
      Object.defineProperty(UILocalizedLabel.prototype, "string", {
        get: function() {
          return this["_string"];
        },
        set: function(value) {
      ...
      Object.defineProperty(UILocalizedLabel.prototype, "stringBlur", {
        set: function(a) {
          this._key ? this.refresh() : this.string = this.updateomitted(this.string);
        },
        enumerable: true,
        configurable: true
      });
      UILocalizedLabel.prototype.onEnable = function() {
        _super.prototype.onEnable.call(this);
        Notify_1.default.instance.on("__i18n__", "refresh", this.refresh, this);
        this.node.on(cc.Node.EventType.SIZE_CHANGED, this.refresh, this);
      };
      UILocalizedLabel.prototype.onDisable = function() {
        _super.prototype.onDisable.call(this);
        Notify_1.default.instance.off("__i18n__", "refresh", this.refresh, this);
        this.node.off(cc.Node.EventType.SIZE_CHANGED, this.refresh, this);
      };
      UILocalizedLabel.prototype.onFocusInEditor = function() {
        this.refresh();
      };
      UILocalizedLabel.prototype.onDestroy = function() {
        _super.prototype.onDestroy.call(this);
      };
      UILocalizedLabel.prototype.setString = function(key) {
        var params = [];
        for (var _i = 1; _i < arguments.length; _i++) params[_i - 1] = arguments[_i];
        var value = "";
        this.__params = params;
        var arr = [ key ].concat(params);
        for (var i = 0; i < arr.length; i++) {
          var k = arr[i];
          Text_1.default[k] ? value += Text_1.default[k][i18n_1.i18n.language] : value += k;
        }
        false;
        this.string = value;
      };
      UILocalizedLabel.prototype.forceUpdateRenderData = function() {
        this["_forceUpdateRenderData"]();
        this.__isInit = true;
      };
      UILocalizedLabel.prototype.getOmittedString = function(text, maxWidth, omitted) {
        var _this = this;
        void 0 === omitted && (omitted = "...");
        var result = "";
        var isAppend = false;
        if (this.cacheMode == cc.Label.CacheMode.CHAR) {
          var currentWidth = 1;
          this.calculationWidth(omitted, function(character, width) {
            currentWidth += width + _this.spacingX;
            return true;
          });
          this.calculationWidth(text, function(character, width) {
            currentWidth += width + _this.spacingX;
          ...
          var allWidth = 0;
          var flowWidth = 0;
          this.calculationWidth(omitted, function(msg, width) {
            flowWidth = width;
          });
          this.calculationWidth(text, function(msg, width) {
            allWidth = width;
          });
      ...
      UILocalizedLabel.prototype.calculationWidth = function(text, pipe) {
        ...
        if (this.cacheMode == cc.Label.CacheMode.CHAR) {
          ...
          for (var i = 0; i < text.length; i++) {
            ...
            var letter = this.shareLabelInfo.fontAtlas.getLetterDefinitionForChar(character, this.shareLabelInfo);
            if (!pipe(character, letter.xAdvance)) break;
          }
        } else {
      ...
      UILocalizedLabel.prototype.getLetterFontDesc = function() {
        var fontDesc = this.shareLabelInfo.fontSize.toString() + "px ";
        fontDesc += this.shareLabelInfo.fontFamily;
        this["_isBold"] && (fontDesc = "bold " + fontDesc);
        return fontDesc;
      };
      UILocalizedLabel.prototype.computeHash = function(labelInfo) {
        var hashData = "";
      ...
      UILocalizedLabel.prototype.updateomitted = function(str) {
        if (this.overflow === cc.Label.Overflow.CLAMP && this.omitted && str) {
      ...
      UILocalizedLabel.prototype.getFontDesc = function() {
        var fontDesc = this.fontSize.toString() + "px ";
        fontDesc += this.currentFontFamily;
        this["_isBold"] && (fontDesc = "bold " + fontDesc);
        this["_isItalic"] && (fontDesc = "italic " + fontDesc);
        return fontDesc;
      };
      UILocalizedLabel.prototype.measureText = function(ctx) {
        return function(string) {
          return cc["textUtils"].safeMeasureText(ctx, string);
        };
      };
      UILocalizedLabel.prototype.getFontFamily = function() {
        var _this = this;
        if (this.useSystemFont) return this.fontFamily || "Arial";
        if (this.font) {
          if (this.font["_nativeAsset"]) return this.font["_nativeAsset"];
          cc.loader.load(this.font.nativeUrl, function(err, asset) {
            _this.font["_nativeAsset"] = asset;
          });
          return "Arial";
        }
        return "Arial";
      };
      UILocalizedLabel.prototype.refresh = function() {
        if (!this.key) return;
        this.setString.apply(this, [ this.key ].concat(this.__params));
      };
      __decorate([ property ], UILocalizedLabel.prototype, "_key", void 0);
      __decorate([ property({
        displayName: "\u672c\u5730\u5316Key"
      }) ], UILocalizedLabel.prototype, "key", null);
      __decorate([ property ], UILocalizedLabel.prototype, "keyBlur", null);
      __decorate([ property({
        override: true
      }) ], UILocalizedLabel.prototype, "string", null);
      __decorate([ property({
        displayName: "\u7701\u7565\u7b26",
        tooltip: "\u6587\u672c\u5185\u5bb9\u8d85\u51fa\u9650\u5236\u5bbd\u5ea6\u65f6\u4f7f\u7528\u7279\u5b9a\u7b26\u53f7\u8fdb\u884c\u7701\u7565"
      }) ], UILocalizedLabel.prototype, "omitted", void 0);
      __decorate([ property ], UILocalizedLabel.prototype, "stringBlur", null);
      UILocalizedLabel = __decorate([ ccclass, menu("UI\u6269\u5c55/\u591a\u8bed\u8a00/UILocalizedLabel"), inspector("packages://extension/UILocalizedLabelInspector.js") ], UILocalizedLabel);
      return UILocalizedLabel;
    }(cc.Label);
    exports.default = UILocalizedLabel;
    cc._RF.pop();
  }, {
    "../../languages/Text": "Text",
    "../../languages/i18n": "i18n",
  ...
  UILocalizedSprite: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "ae26copnJJCbr/lZqD7Z9Xp", "UILocalizedSprite");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var Notify_1 = require("../cores/Notify");
    var i18n_1 = require("../../languages/i18n");
    var Sprite_1 = require("../../languages/Sprite");
    var Runtime_1 = require("../singles/Runtime");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property, menu = _a.menu, inspector = _a.inspector;
    var UILocalizedSprite = function(_super) {
      __extends(UILocalizedSprite, _super);
      function UILocalizedSprite() {
        var _this = _super.call(this) || this;
        _this._key = "";
        false;
        Notify_1.default.instance.on("__i18n__", "refresh", _this.refresh, _this);
      ...
      Object.defineProperty(UILocalizedSprite.prototype, "key", {
        get: function() {
          return this._key;
        },
        set: function(value) {
          var oldKey = this._key;
          this._key = value;
          this.key !== oldKey && this.setSprite(value);
        },
        enumerable: true,
        configurable: true
      });
      UILocalizedSprite.prototype.setSprite = function(key) {
        return __awaiter(this, void 0, void 0, function() {
          var module, dirname, modulePath, spritePath;
          var _this = this;
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              if (!Sprite_1.default[key]) return [ 3, 2 ];
              return [ 4, Runtime_1.default.instance.load().catch(cc.error) ];

             case 1:
              _a.sent();
              module = Sprite_1.default[key].module;
              dirname = Runtime_1.default.instance.isSubpackage(module) ? "subModules" : "mainModules";
              modulePath = cc.path.join(dirname, module);
              spritePath = cc.path.join(modulePath, "layouts", Runtime_1.default.instance.getLayout(module), "skins", Runtime_1.default.instance.getSkin(module), Sprite_1.default[key][i18n_1.i18n.language]);
              cc.loader.loadRes(spritePath, cc.SpriteFrame, function(err, result) {
                if (err) return cc.error(err);
                _this.spriteFrame = result;
              });
              return [ 3, 3 ];
      ...
      UILocalizedSprite.prototype.onFocusInEditor = function() {
        this.refresh();
      };
      UILocalizedSprite.prototype.onDestroy = function() {
        _super.prototype.onDestroy.call(this);
        Notify_1.default.instance.offContext(this);
      };
      UILocalizedSprite.prototype.refresh = function() {
        if (!this.key) return;
        this.setSprite(this.key);
      };
      __decorate([ property ], UILocalizedSprite.prototype, "_key", void 0);
      __decorate([ property ], UILocalizedSprite.prototype, "key", null);
      UILocalizedSprite = __decorate([ ccclass, menu("UI\u6269\u5c55/\u591a\u8bed\u8a00/UILocalizedSprite"), inspector("packages://extension/UILocalizedSpriteInspector.js") ], UILocalizedSprite);
      return UILocalizedSprite;
    }(cc.Sprite);
    exports.default = UILocalizedSprite;
    cc._RF.pop();
  }, {
    "../../languages/Sprite": "Sprite",
    "../../languages/i18n": "i18n",
    "../cores/Notify": "Notify",
    "../singles/Runtime": "Runtime"
  } ],
  UIScrollView: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "8d7e3POF5hAqq7XLdkDTQVK", "UIScrollView");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property, menu = _a.menu, inspector = _a.inspector, executeInEditMode = _a.executeInEditMode;
    var UIScrollViewBoundEventType;
    (function(UIScrollViewBoundEventType) {
      UIScrollViewBoundEventType[UIScrollViewBoundEventType["STOP"] = 0] = "STOP";
      UIScrollViewBoundEventType[UIScrollViewBoundEventType["REFRESH"] = 1] = "REFRESH";
      UIScrollViewBoundEventType[UIScrollViewBoundEventType["LOAD"] = 2] = "LOAD";
      UIScrollViewBoundEventType[UIScrollViewBoundEventType["REFRESH_HANDLER"] = 3] = "REFRESH_HANDLER";
      UIScrollViewBoundEventType[UIScrollViewBoundEventType["LOAD_HANDLER"] = 4] = "LOAD_HANDLER";
    })(UIScrollViewBoundEventType = exports.UIScrollViewBoundEventType || (exports.UIScrollViewBoundEventType = {}));
    var UIScrollViewDirection;
    (function(UIScrollViewDirection) {
      UIScrollViewDirection[UIScrollViewDirection["HORIZONTAL"] = 0] = "HORIZONTAL";
      UIScrollViewDirection[UIScrollViewDirection["VERTICAL"] = 1] = "VERTICAL";
      UIScrollViewDirection[UIScrollViewDirection["NONE"] = 2] = "NONE";
    })(UIScrollViewDirection = exports.UIScrollViewDirection || (exports.UIScrollViewDirection = {}));
    var UIScrollView = function(_super) {
      __extends(UIScrollView, _super);
      function UIScrollView() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this.direction = UIScrollViewDirection.NONE;
        _this._maxItemCount = 0;
        _this.cacheItems = [];
        _this.prevScrollOffset = cc.Vec2.ZERO;
        _this.curItemCount = 0;
        _this.boundEventType = UIScrollViewBoundEventType.STOP;
        _this.isTransmitEvent = false;
        _this.isOptimization = false;
        _this.refreshOffset = 0;
        _this.loadOffset = 0;
        _this._spacing = cc.Vec2.ZERO;
        _this._boundaryEvents = [];
        _this._refreshItemEvents = [];
        _this._horizontal = false;
        _this._vertical = true;
        _this._fixedNode = null;
        return _this;
      }
      Object.defineProperty(UIScrollView.prototype, "maxItemCount", {
        get: function() {
      ...
      UIScrollView.prototype.setItemCount = function(itemCount) {
        this.maxItemCount = itemCount;
        this.layoutContent();
        return this;
      };
      UIScrollView.prototype.addItemCount = function(itemCount) {
        if (itemCount < 0) return;
        if (0 == this.maxItemCount) this.setItemCount(itemCount); else {
          0 !== itemCount && this.stopAutoScroll();
          this.maxItemCount += itemCount || 0;
        }
        return this;
      };
      UIScrollView.prototype.remItemCount = function(itemCount) {
        if (itemCount < 0) return;
        this.maxItemCount -= itemCount || 0;
        return this;
      };
      Object.defineProperty(UIScrollView.prototype, "view", {
        get: function() {
          return this["_view"];
        },
        enumerable: true,
      ...
      Object.defineProperty(UIScrollView.prototype, "spacing", {
        get: function() {
      ...
      Object.defineProperty(UIScrollView.prototype, "boundaryEvents", {
        get: function() {
          return this._boundaryEvents;
        },
        set: function(value) {
      ...
      Object.defineProperty(UIScrollView.prototype, "refreshItemEvents", {
        get: function() {
          return this._refreshItemEvents;
        },
        set: function(value) {
      ...
      Object.defineProperty(UIScrollView.prototype, "horizontal", {
        get: function() {
      ...
      Object.defineProperty(UIScrollView.prototype, "vertical", {
        get: function() {
      ...
      Object.defineProperty(UIScrollView.prototype, "fixedNode", {
        get: function() {
          if (!this._fixedNode) {
      ...
      Object.defineProperty(UIScrollView.prototype, "viewWidget", {
        get: function() {
          if (!this._viewWidget) {
            this._viewWidget = this.view.getComponent(cc.Widget);
            this._viewWidget || (this._viewWidget = this.view.addComponent(cc.Widget));
          }
      ...
      UIScrollView.prototype.onLoad = function() {
        ...
        this.node.anchorY = .5;
        if (this.content) {
          this._horizontal && (this.content.anchorX = 0);
          this._vertical && (this.content.anchorY = 1);
      ...
      UIScrollView.prototype._onTouchBegan = function(event, captureListeners) {
        _super.prototype["_onTouchBegan"].call(this, event, captureListeners);
        this.direction = UIScrollViewDirection.NONE;
        this.isTransmitEvent && this.transmitEvent(event, cc.Node.EventType.TOUCH_START);
      };
      UIScrollView.prototype._onTouchMoved = function(event, captureListeners) {
        ...
        if (this.direction == UIScrollViewDirection.NONE) {
          ...
          xOffset > yOffset ? this.direction = UIScrollViewDirection.HORIZONTAL : yOffset > xOffset && (this.direction = UIScrollViewDirection.VERTICAL);
        }
        ...
        if (canTransmit) {
          ...
          var deltaMove = event.touch.getLocation().sub(event.touch.getStartLocation()).mag();
          if (event.target !== this.node && event.target.getComponent(cc.Button) && deltaMove > 7) {
            var bt = event.target.getComponent(cc.Button);
            bt._pressed = false;
          }
        } else _super.prototype["_onTouchMoved"].call(this, event, captureListeners);
      };
      UIScrollView.prototype._onTouchEnded = function(event, captureListeners) {
        _super.prototype["_onTouchEnded"].call(this, event, captureListeners);
        this.direction = UIScrollViewDirection.NONE;
        this.isTransmitEvent && this.transmitEvent(event, cc.Node.EventType.TOUCH_END);
      };
      UIScrollView.prototype._onTouchCancelled = function(event, captureListeners) {
        _super.prototype["_onTouchCancelled"].call(this, event, captureListeners);
        this.isTransmitEvent && this.transmitEvent(event, cc.Node.EventType.TOUCH_CANCEL);
      };
      UIScrollView.prototype._onMouseWheel = function(event, captureListeners) {
        _super.prototype["_onMouseWheel"].call(this, event, captureListeners);
        this.isTransmitEvent && this.transmitEvent(event, cc.Node.EventType.MOUSE_WHEEL);
      };
      UIScrollView.prototype.transmitEvent = function(event, eventType) {
        var e = new cc.Event.EventTouch(event.getTouches(), event.bubbles);
        e.type = eventType;
        e.touch = event.touch;
        event.target.parent.dispatchEvent(e);
      };
      UIScrollView.prototype.checkLength = function() {
        if (!this.content) return;
        0 == this.cacheItems.length && (this.cacheItems = Object.assign([], this.content.children));
        for (var i = 0; i < this.cacheItems.length; i++) {
          var child = this.cacheItems[i];
          if (i < this._maxItemCount) {
            if (child.parent != this.content) {
              child.parent = this.content;
              child.active = true;
            }
          } else if (child.parent != this.node) {
            child.parent = this.node;
            child.active = false;
          }
        }
      };
      UIScrollView.prototype.resetView = function() {
        ...
        this.bounceDuration = .618;
        this.stop();
      };
      UIScrollView.prototype.viewByRefresh = function() {
        if (this.horizontal) {
      ...
      UIScrollView.prototype.viewByLoad = function() {
        if (this.horizontal) {
          this.viewWidget.left = 0;
      ...
      UIScrollView.prototype.layoutContent = function() {
        if (!this.isOptimization) return;
        this.horizontal ? this.content.width = 0 : this.vertical && (this.content.height = 0);
        this.stopAutoScroll();
        var prev = cc.Vec2.ZERO;
        for (var i = 0; i < this.content.childrenCount; i++) {
          ...
          if (this.horizontal) {
            child.anchorX = .5;
            var width = child.width * child.scaleX;
            child.x = .5 * width + prev.x + this.spacing.x * i;
            prev.x += width;
            this.content.width += width;
            i > 0 && (this.content.width += this.spacing.x);
          } else if (this.vertical) {
            child.anchorY = .5;
            var height = child.height * child.scaleY;
            child.y = .5 * -height - prev.y - this.spacing.y * i;
            prev.y += height;
            this.content.height += height;
            i > 0 && (this.content.height += this.spacing.y);
          }
          true;
      ...
      UIScrollView.prototype._dispatchEvent = function(event) {
        _super.prototype["_dispatchEvent"].call(this, event);
        if (!this.isOptimization) return;
        this.horizontal ? this.horizontalHandler() : this.vertical && this.verticalHandler();
        this.prevScrollOffset = this.getScrollOffset();
      };
      UIScrollView.prototype._onScrollBarTouchEnded = function() {
        _super.prototype["_onScrollBarTouchEnded"].call(this);
      ...
      UIScrollView.prototype.horizontalHandler = function() {
        ...
        if (this.prevScrollOffset.x > this.getScrollOffset().x) {
          if (header.getBoundingBoxToWorld().xMax + this.spacing.x < this.fixedNode.getBoundingBoxToWorld().xMin && this.curItemCount < this.maxItemCount) {
            header.setSiblingIndex(this.content.childrenCount);
            header.x = footer.x + header.width * header.scaleX + this._spacing.x;
            header.x += .5 * (footer.width * footer.scaleX - header.width * header.scaleX);
            this.content.width += header.width * header.scaleX + this._spacing.x;
            var index = parseInt(footer.name) + 1;
            header.name = index.toString();
            cc.Component.EventHandler.emitEvents(this.refreshItemEvents, header, index);
            this.curItemCount++;
          }
        } else if (this.prevScrollOffset.x < this.getScrollOffset().x && footer.getBoundingBoxToWorld().xMin - this.spacing.x > this.fixedNode.getBoundingBoxToWorld().xMax && this.getScrollOffset().x < 0 && this.curItemCount - 1 >= this.content.childrenCount) {
          footer.setSiblingIndex(0);
          footer.x = header.x - footer.width * footer.scaleX - this._spacing.x;
          footer.x -= .5 * (header.width * header.scaleX - footer.width * footer.scaleX);
          this.content.width -= footer.width * footer.scaleX + this._spacing.x;
          var index = parseInt(header.name) - 1;
          footer.name = index.toString();
          cc.Component.EventHandler.emitEvents(this.refreshItemEvents, footer, index);
          this.curItemCount--;
        }
        this.boundEventType !== UIScrollViewBoundEventType.LOAD_HANDLER && this.boundEventType !== UIScrollViewBoundEventType.REFRESH_HANDLER && this.isScrolling() && (this.getScrollOffset().x >= this.refreshOffset ? this.refresh() : Math.abs(this.getScrollOffset().x) - this.loadOffset > this.getMaxScrollOffset().x ? this.load() : this.stop());
      };
      UIScrollView.prototype.verticalHandler = function() {
        if (this.prevScrollOffset.y == this.getScrollOffset().y) return;
        var header = this.content.children[0];
        var footer = this.content.children[this.content.childrenCount - 1];
        if (!header || !footer) return;
        if (this.prevScrollOffset.y < this.getScrollOffset().y) {
          if (header.getBoundingBoxToWorld().yMin - this.spacing.y > this.fixedNode.getBoundingBoxToWorld().yMax && this.curItemCount < this.maxItemCount) {
            header.setSiblingIndex(this.content.childrenCount);
            header.y = footer.y - header.height * header.scaleY - this._spacing.y;
            header.y -= .5 * (footer.height * footer.scaleY - header.height * header.scaleY);
        ...
        } else if (this.prevScrollOffset.y > this.getScrollOffset().y && footer.getBoundingBoxToWorld().yMax + this.spacing.y < this.fixedNode.getBoundingBoxToWorld().yMin && this.getScrollOffset().y > 0 && this.curItemCount - 1 >= this.content.childrenCount) {
          footer.setSiblingIndex(0);
          footer.y = header.y + footer.height * footer.scaleY + this._spacing.y;
          footer.y += .5 * (header.height * header.scaleY - footer.height * footer.scaleY);
        ...
        this.boundEventType !== UIScrollViewBoundEventType.LOAD_HANDLER && this.boundEventType !== UIScrollViewBoundEventType.REFRESH_HANDLER && this.isScrolling() && (this.getScrollOffset().y < -this.refreshOffset ? this.refresh() : this.getScrollOffset().y - this.loadOffset > this.getMaxScrollOffset().y ? this.load() : this.stop());
      };
      UIScrollView.prototype.refresh = function() {
      ...
      UIScrollView.prototype.load = function() {
      ...
      UIScrollView.prototype.stop = function() {
        if (this.boundEventType !== UIScrollViewBoundEventType.STOP) {
          this.boundEventType = UIScrollViewBoundEventType.STOP;
          cc.Component.EventHandler.emitEvents(this.boundaryEvents, this.boundEventType);
        }
      };
      UIScrollView.prototype.onEnable = function() {
        _super.prototype.onEnable.call(this);
        this.addContentEventListeners();
      };
      UIScrollView.prototype.onDisable = function() {
        _super.prototype.onDisable.call(this);
        this.removeContentEventListeners();
      };
      UIScrollView.prototype.addContentEventListeners = function() {
        true;
        return;
      };
      UIScrollView.prototype.removeContentEventListeners = function() {
        true;
        return;
      };
      __decorate([ property({
      ...
      }) ], UIScrollView.prototype, "isTransmitEvent", void 0);
      __decorate([ property({
        displayName: "\u5f00\u542f\u4f18\u5316"
      }) ], UIScrollView.prototype, "isOptimization", void 0);
      __decorate([ property({
        displayName: "\u4e0b\u62c9\u5237\u65b0\u504f\u79fb\u91cf"
      }) ], UIScrollView.prototype, "refreshOffset", void 0);
      __decorate([ property({
        displayName: "\u4e0a\u62c9\u52a0\u8f7d\u504f\u79fb\u91cf"
      }) ], UIScrollView.prototype, "loadOffset", void 0);
      __decorate([ property ], UIScrollView.prototype, "_spacing", void 0);
      __decorate([ property({
        displayName: "item\u95f4\u9694"
      }) ], UIScrollView.prototype, "spacing", null);
      __decorate([ property(cc.Component.EventHandler) ], UIScrollView.prototype, "_boundaryEvents", void 0);
      __decorate([ property({
        type: cc.Component.EventHandler,
        displayName: "\u8fb9\u754c\u4e8b\u4ef6",
        tooltip: "\u4e0b\u62c9\u5237\u65b0,\u4e0a\u62c9\u52a0\u8f7d"
      }) ], UIScrollView.prototype, "boundaryEvents", null);
      __decorate([ property(cc.Component.EventHandler) ], UIScrollView.prototype, "_refreshItemEvents", void 0);
      __decorate([ property({
        type: cc.Component.EventHandler,
        displayName: "\u5237\u65b0item\u4e8b\u4ef6"
      }) ], UIScrollView.prototype, "refreshItemEvents", null);
      __decorate([ property ], UIScrollView.prototype, "_horizontal", void 0);
      __decorate([ property({
        override: true
      }) ], UIScrollView.prototype, "horizontal", null);
      __decorate([ property ], UIScrollView.prototype, "_vertical", void 0);
      __decorate([ property({
        override: true
      }) ], UIScrollView.prototype, "vertical", null);
      UIScrollView = __decorate([ ccclass, menu("UI\u6269\u5c55/UIScrollView"), inspector("packages://extension/UIScrollViewInspector.js"), executeInEditMode() ], UIScrollView);
      return UIScrollView;
    }(cc.ScrollView);
    exports.default = UIScrollView;
    cc._RF.pop();
  }, {} ],
  Update: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "0b649f2tUxC/aiKU22usQ6k", "Update");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var Runtime_1 = require("../singles/Runtime");
    var Company_1 = require("../singles/Company");
    var Update = function() {
      function Update(name) {
        this.projectManifest = "project.manifest";
        this.versionManifest = "version.manifest";
        this.remote_assets = "remote-assets";
        this.retryCount = 3;
        this.name = name;
        if (!Utils_1.default.isHotUpdate) return;
      ...
      Update.prototype.checkUpdate = function() {
        var _this = this;
        return new Promise(function(resolve, reject) {
          if (!_this.isHotUpdate()) return resolve(false);
          if (!_this.initManifest()) return reject((_this.name || "fromework") + " \u68c0\u67e5\u65f6 \u521d\u59cb\u5316manifest\u5931\u8d25");
          _this.assetsManager.setEventCallback(function(event) {
            switch (event.getEventCode()) {
             case jsb.EventAssetsManager.ERROR_NO_LOCAL_MANIFEST:
              return reject("ERROR_NO_LOCAL_MANIFEST " + (_this.name || "fromework") + " \u68c0\u67e5\u66f4\u65b0\u5931\u8d25: \u6ca1\u6709\u627e\u5230\u672c\u5730manifest\u6587\u4ef6");

             case jsb.EventAssetsManager.ERROR_DOWNLOAD_MANIFEST:
              return reject("ERROR_DOWNLOAD_MANIFEST " + (_this.name || "fromework") + " \u4e0b\u8f7d manifest \u5931\u8d25");

             case jsb.EventAssetsManager.ERROR_PARSE_MANIFEST:
              return reject("ERROR_PARSE_MANIFEST " + (_this.name || "fromework") + " \u4e0b\u8f7d manifest \u5931\u8d25");
          ...
          cc.log((_this.name || "fromework") + " \u68c0\u67e5\u4e2d...");
          _this.assetsManager.checkUpdate();
        });
      };
      Update.prototype.install = function(progressEvent) {
        var _this = this;
        return new Promise(function(resolve, reject) {
          var _a;
          if (!_this.isHotUpdate()) return resolve(false);
          var packageUrl = urlJoin(Company_1.default.instance.hotUpdateUrl, Runtime_1.default.instance.template, "/subpackages/", _this.name);
          var zipKey = _this.name + ".zip";
          var manifest = {
          ...
          var localObj = new jsb.Manifest(JSON.stringify(manifest), _this.localSavePath);
          _this.assetsManager.loadLocalManifest(localObj, _this.localSavePath);
          manifest.version = "1.0.0";
          manifest.assets[zipKey].md5 = "1";
          var remoteObj = new jsb.Manifest(JSON.stringify(manifest), _this.localSavePath);
          _this.assetsManager.loadRemoteManifest(remoteObj);
          _this.startUpdate(progressEvent).then(function() {
            resolve(true);
          }).catch(reject);
        });
      };
      Update.prototype.startUpdate = function(progressEvent) {
        var _this = this;
        return new Promise(function(resolve, reject) {
          if (!_this.isHotUpdate()) return resolve(false);
          if (!_this.initManifest()) return reject((_this.name || "fromework") + " \u66f4\u65b0\u65f6 \u521d\u59cb\u5316manifest\u5931\u8d25");
          var progress = new HotUpdateProgressEvent();
          progressEvent = progressEvent || function() {};
          _this.assetsManager.setEventCallback(function(event) {
            switch (event.getEventCode()) {
             case jsb.EventAssetsManager.READY_TO_UPDATE:
              cc.log((_this.name || "fromework") + " \u65ad\u70b9\u7eed\u4f20: " + event.isResuming());
              break;

             case jsb.EventAssetsManager.NEW_VERSION_FOUND:
              cc.log((_this.name || "fromework") + " \u627e\u5230\u4e86\u6700\u65b0\u7684\u7248\u672c\u6587\u4ef6");
              var remote = _this.assetsManager.getRemoteManifest();
              remote && _this.setRemoteUrls(remote);
              break;
             ...
             case jsb.EventAssetsManager.ERROR_NO_LOCAL_MANIFEST:
              _this.assetsManager.setEventCallback(null);
              reject((_this.name || "fromework") + " \u672c\u5730 manifest \u9519\u8bef");
              break;

             case jsb.EventAssetsManager.ERROR_DOWNLOAD_MANIFEST:
              _this.assetsManager.setEventCallback(null);
              reject((_this.name || "fromework") + " \u4e0b\u8f7d manifest \u9519\u8bef");
              break;

             case jsb.EventAssetsManager.ERROR_PARSE_MANIFEST:
              _this.assetsManager.setEventCallback(null);
              reject((_this.name || "fromework") + " \u89e3\u6790 manifest \u9519\u8bef");
              break;

             case jsb.EventAssetsManager.ERROR_DECOMPRESS:
              cc.error((_this.name || "fromework") + " \u89e3\u538b\u6587\u4ef6" + event.getAssetId() + "\u5931\u8d25,\u539f\u56e0:" + event.getMessage());
              _this.assetsManager.setEventCallback(null);
              reject((_this.name || "fromework") + " \u6a21\u5757\u89e3\u538b\u6587\u4ef6" + event.getAssetId() + "\u5931\u8d25");
              break;

             case jsb.EventAssetsManager.ERROR_UPDATING:
              cc.warn((_this.name || "fromework") + " \u4e0b\u8f7d\u6587\u4ef6" + event.getAssetId() + "\u5931\u8d25,\u539f\u56e0:" + event.getMessage());
              break;

             case jsb.EventAssetsManager.ALREADY_UP_TO_DATE:
              cc.log((_this.name || "fromework") + " \u5df2\u7ecf\u662f\u6700\u65b0\u7248\u672c");
              _this.assetsManager.setEventCallback(null);
              resolve(false);
              break;

             case jsb.EventAssetsManager.UPDATE_FINISHED:
              cc.log((_this.name || "fromework") + " \u66f4\u65b0\u5b8c\u6210\uff01");
              _this.assetsManager.setEventCallback(null);
              _this.updateSearchPath();
              resolve(true);
              break;

             case jsb.EventAssetsManager.UPDATE_FAILED:
              if (_this.retryCount > 0) {
                _this.assetsManager.downloadFailedAssets();
                _this.retryCount--;
                cc.error((_this.name || "fromework") + " \u66f4\u65b0\u5931\u8d25\uff01\u5c1d\u8bd5\u91cd\u65b0\u4e0b\u8f7d \u5269\u4f59\u4e0b\u8f7d\u6b21\u6570:" + _this.retryCount);
              } else {
                _this.assetsManager.setEventCallback(null);
                reject((_this.name || "fromework") + " \u66f4\u65b0\u5931\u8d25");
              }
              break;

             case jsb.EventAssetsManager.ASSET_UPDATED:
              cc.log((_this.name || "fromework") + " \u4e0b\u8f7d\u6587\u4ef6" + event.getAssetId() + "\u6210\u529f");
              if (".zip" == cc.path.extname(event.getAssetId())) {
                var manifestFile = cc.path.join(_this.localSavePath + "_temp", _this.projectManifest + ".temp");
                var isExists = jsb.fileUtils.isFileExist(manifestFile);
                isExists && jsb.fileUtils.removeFile(manifestFile);
              }
            }
          });
          cc.log((_this.name || "fromework") + " \u66f4\u65b0\u4e2d...");
          _this.assetsManager.update();
        });
      };
      Update.prototype.isHotUpdate = function() {
        if (!Utils_1.default.isHotUpdate) return false;
        if (this.name && !Runtime_1.default.instance.isSubpackage(this.name)) return false;
        return true;
      };
      Update.prototype.initManifest = function() {
        if (this.assetsManager.getState() == jsb.AssetsManager.State.UNINITED) {
          var manifest_1 = this.getManifest();
          var manifestObj = new jsb.Manifest(JSON.stringify(manifest_1), this.localSavePath);
          this.assetsManager.loadLocalManifest(manifestObj, this.localSavePath);
          cc.log((this.name || "fromework") + " \u6a21\u5757:\u521d\u59cb\u5316manifest", manifest_1);
        }
        ...
        var manifest = this.assetsManager.getLocalManifest();
        this.setRemoteUrls(manifest);
        return true;
      };
      Update.prototype.getManifest = function() {
        var manifest = {
          packageUrl: "",
          remoteManifestUrl: "",
          remoteVersionUrl: "",
        ...
        0 != json && (manifest = JSON.parse(json));
        return manifest;
      };
      Update.prototype.setRemoteUrls = function(manifest) {
        var relativePath = path_1.relative(jsb.fileUtils.getWritablePath(), this.localSavePath).replace(this.remote_assets, "");
        manifest.setPackageUrl(urlJoin(Company_1.default.instance.hotUpdateUrl, Runtime_1.default.instance.template, "/"));
      ...
      Update.prototype.updateSearchPath = function() {
      ...
      Update.prototype.versionCompareHandle = function(versionA, versionB) {
      ...
      Update.prototype.verifyCallback = function(path, asset) {
    ...
    var HotUpdateProgressEvent = function() {
      function HotUpdateProgressEvent() {}
      return HotUpdateProgressEvent;
    }();
    exports.HotUpdateProgressEvent = HotUpdateProgressEvent;
    cc._RF.pop();
  }, {
    "../singles/Company": "Company",
    "../singles/Runtime": "Runtime",
    "../tools/Utils": "Utils",
    path: 112,
    "url-join": 157
  ...
  Utils: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "5ec08bGvbdM4pgi1JFibwRh", "Utils");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var crypto = require("crypto");
    var Utils = function() {
      function Utils() {}
      Object.defineProperty(Utils, "isHotUpdate", {
        get: function() {
          return cc.sys.isNative && !cc.sys.isBrowser && true;
        },
        enumerable: true,
        configurable: true
      });
      Utils.md5String = function(str) {
        return crypto.createHash("md5").update(str, "utf8").digest("hex");
      };
      Utils.beautySub = function(str, len, flow) {
        flow = flow || "...";
        var reg = /[\u4e00-\u9fa5]/g, slice = str.substring(0, len), chineseCharNum = ~~(slice.match(reg) && slice.match(reg).length), realen = 2 * slice.length - chineseCharNum;
  ...
  common_main: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "58bff2BypBODYFLGC0WcLc9", "common_main");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var AbstractView_1 = require("../../../../../fromework/abstract/mvvm/AbstractView");
    var common_view_model_1 = require("../../../scripts/common_view_model");
    var AbstractView_2 = require("../../../../../fromework/abstract/mvvm/AbstractView");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var common_main = function(_super) {
      __extends(common_main, _super);
      ...
      common_main.prototype.onLoad = function() {};
      common_main.prototype.__testVar = function(value) {
        cc.log(value);
      };
      __decorate([ property(cc.Label) ], common_main.prototype, "label", void 0);
      __decorate([ property ], common_main.prototype, "text", void 0);
      __decorate([ AbstractView_1.Binding ], common_main.prototype, "__testVar", null);
      common_main = __decorate([ ccclass, AbstractView_1.ViewModel("common", common_view_model_1.default) ], common_main);
      return common_main;
    }(AbstractView_2.default);
    exports.default = common_main;
    cc._RF.pop();
  }, {
    "../../../../../fromework/abstract/mvvm/AbstractView": "AbstractView",
    "../../../scripts/common_view_model": "common_view_model"
  } ],
  common_model: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "ec09dRZ8ptAM4wbarfv9beq", "common_model");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var AbstractModel_1 = require("../../../fromework/abstract/mvvm/AbstractModel");
    var common_model = function(_super) {
      __extends(common_model, _super);
      function common_model() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this.__common_refresh = 0;
        return _this;
      }
      common_model.prototype.loaded = function() {
        var _this = this;
        setInterval(function() {
          _this.__common_refresh++;
        }, 1e3);
      };
      common_model.prototype.unload = function() {};
      __decorate([ AbstractModel_1.Mutable ], common_model.prototype, "__common_refresh", void 0);
      return common_model;
    }(AbstractModel_1.default);
    exports.default = common_model;
    cc._RF.pop();
  }, {
    "../../../fromework/abstract/mvvm/AbstractModel": "AbstractModel"
  } ],
  common_view_model: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "69afd275kZItLnJmNr8JaY9", "common_view_model");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var AbstractViewModel_1 = require("../../../fromework/abstract/mvvm/AbstractViewModel");
    var common_model_1 = require("./common_model");
    var common_view_model = function(_super) {
      __extends(common_view_model, _super);
      function common_view_model() {
        return null !== _super && _super.apply(this, arguments) || this;
      }
      common_view_model.prototype.loaded = function() {};
      common_view_model.prototype.unload = function() {};
      common_view_model.prototype.onClick = function(event) {};
      __decorate([ AbstractViewModel_1.Bindable ], common_view_model.prototype, "__testVar", void 0);
      __decorate([ AbstractViewModel_1.Command ], common_view_model.prototype, "onClick", null);
      common_view_model = __decorate([ AbstractViewModel_1.Model(common_model_1.default) ], common_view_model);
      return common_view_model;
    }(AbstractViewModel_1.AbstractViewModel);
    exports.default = common_view_model;
    cc._RF.pop();
  }, {
    "../../../fromework/abstract/mvvm/AbstractViewModel": "AbstractViewModel",
    "./common_model": "common_model"
  } ],
  common: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "74d6brlwaVI97Xp05X0tVp4", "common");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var common = function(_super) {
      ...
      common.prototype.clear = function() {};
      common.prototype.onLoad = function() {};
      common = __decorate([ AbstractModule_1.Module("common"), ccclass ], common);
      return common;
    }(AbstractModule_1.default);
    exports.default = common;
    cc._RF.pop();
  }, {
    "../../../fromework/abstract/mvvm/AbstractModule": "AbstractModule"
  } ],
  i18n: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "ee3005LQO9OlJMheOjS5vZ7", "i18n");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var Notify_1 = require("../fromework/cores/Notify");
    var Languages;
    (function(Languages) {
      Languages["en"] = "en";
    ...
    var i18n = function() {
      ...
      Object.defineProperty(i18n, "language", {
        ...
        set: function(value) {
          ...
          Notify_1.default.instance.emit("__i18n__", "refresh");
        },
        enumerable: true,
        configurable: true
      });
      i18n._language = Languages.zh_cn;
      i18n.text = {
    ...
    "../fromework/cores/Notify": "Notify"
  } ],
  launch_main: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "52d43RA3CZOlpMW9eGb/lrF", "launch_main");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var AbstractView_1 = require("../../../../../fromework/abstract/mvvm/AbstractView");
    var launch_view_model_1 = require("../../../scripts/launch_view_model");
    var AbstractView_2 = require("../../../../../fromework/abstract/mvvm/AbstractView");
    var Utils_1 = require("../../../../../fromework/tools/Utils");
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var launch_main = function(_super) {
      __extends(launch_main, _super);
      function launch_main() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this.tipsLabel = null;
        _this.bytesLabel = null;
        _this.progressBar = null;
        return _this;
      }
      launch_main.prototype.onLoad = function() {
        this.viewModel.initLaunch();
      };
      launch_main.prototype.__percentByByte = function(value) {
        if (isNaN(value)) return this.progressBar.progress = 0;
        this.progressBar.progress = value;
        var str = Math.floor(100 * value);
        this.tipsLabel.string = (str > 100 ? 100 : str) + "%";
      };
      launch_main.prototype.__progressEventData = function(event) {
        if (!event) return this.bytesLabel.string = "";
        this.bytesLabel.string = Utils_1.default.formatBytes(event.downloadedBytes) + "/" + Utils_1.default.formatBytes(event.totalBytes);
      };
      __decorate([ property(cc.Label) ], launch_main.prototype, "tipsLabel", void 0);
      __decorate([ property(cc.Label) ], launch_main.prototype, "bytesLabel", void 0);
      __decorate([ property(cc.ProgressBar) ], launch_main.prototype, "progressBar", void 0);
      __decorate([ AbstractView_1.Binding ], launch_main.prototype, "__percentByByte", null);
      __decorate([ AbstractView_1.Binding ], launch_main.prototype, "__progressEventData", null);
      launch_main = __decorate([ ccclass, AbstractView_1.ViewModel("launch", launch_view_model_1.default) ], launch_main);
      return launch_main;
    }(AbstractView_2.default);
    exports.default = launch_main;
    [ {
      launch_header: {
        note: "\u542f\u52a8\u573a\u666f\u6807\u9898",
        zh_cn: "\u542f\u52a8\u573a\u666f",
    ...
    "../../../../../fromework/abstract/mvvm/AbstractView": "AbstractView",
    "../../../../../fromework/tools/Utils": "Utils",
    "../../../scripts/launch_view_model": "launch_view_model"
  } ],
  launch_model: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "d9135loLFBB+LHwKZCfwUWD", "launch_model");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var AbstractModel_1 = require("../../../fromework/abstract/mvvm/AbstractModel");
    var launch_model = function(_super) {
      __extends(launch_model, _super);
      function launch_model() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this.__testVar = "\u6211\u662f\u9ed8\u8ba4\u503c";
        return _this;
      }
      launch_model.prototype.loaded = function() {};
      launch_model.prototype.unload = function() {};
      __decorate([ AbstractModel_1.Mutable ], launch_model.prototype, "__testVar", void 0);
      return launch_model;
    }(AbstractModel_1.default);
    exports.default = launch_model;
    cc._RF.pop();
  }, {
    "../../../fromework/abstract/mvvm/AbstractModel": "AbstractModel"
  } ],
  launch_view_model: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "55d90BQEUZIer1b2AKrUHDf", "launch_view_model");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var AbstractViewModel_1 = require("../../../fromework/abstract/mvvm/AbstractViewModel");
    var launch_model_1 = require("./launch_model");
    var Runtime_1 = require("../../../fromework/singles/Runtime");
    var Company_1 = require("../../../fromework/singles/Company");
    var ModuleUpdate_1 = require("../../../fromework/singles/ModuleUpdate");
    var Facade_1 = require("../../../fromework/cores/Facade");
    var launch_view_model = function(_super) {
      __extends(launch_view_model, _super);
      function launch_view_model() {
        return null !== _super && _super.apply(this, arguments) || this;
      }
      launch_view_model.prototype.loaded = function() {};
      launch_view_model.prototype.unload = function() {};
      launch_view_model.prototype.initLaunch = function() {
        return __awaiter(this, void 0, void 0, function() {
          var runtime, company, isRestart;
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              return [ 4, Runtime_1.default.instance.load() ];

             case 1:
              runtime = _a.sent();
              return [ 4, Company_1.default.instance.load() ];

             case 2:
              company = _a.sent();
              cc.log("company:", company);
              cc.log("runtime:", runtime);
              return [ 4, this.install() ];
             ...
             case 3:
              ...
              Facade_1.default.getModule("common");
              return [ 4, this.install("login") ];

             case 4:
              _a.sent();
              return [ 4, this.install("lobby") ];
      ...
      launch_view_model.prototype.install = function(name) {
        var _this = this;
        return new Promise(function(resolve, reject) {
          return __awaiter(_this, void 0, void 0, function() {
            return __generator(this, function(_a) {
              switch (_a.label) {
               case 0:
                return [ 4, ModuleUpdate_1.default.instance.getTask(name).install(this.progressEvent.bind(this)).then(function(result) {
                  resolve(result);
                }).catch(cc.error) ];
      ...
      launch_view_model.prototype.progressEvent = function(event) {
        this.__progressEventData = event;
        this.__percentByByte = event.percentByByte;
      };
      launch_view_model = __decorate([ AbstractViewModel_1.Model(launch_model_1.default) ], launch_view_model);
      return launch_view_model;
    }(AbstractViewModel_1.AbstractViewModel);
    exports.default = launch_view_model;
    cc._RF.pop();
  }, {
    "../../../fromework/abstract/mvvm/AbstractViewModel": "AbstractViewModel",
    "../../../fromework/cores/Facade": "Facade",
    "../../../fromework/singles/Company": "Company",
    "../../../fromework/singles/ModuleUpdate": "ModuleUpdate",
    "../../../fromework/singles/Runtime": "Runtime",
    "./launch_model": "launch_model"
  } ],
  launch: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "2eaebM+46pGe7o/WHmG/Fuk", "launch");
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var AbstractModule_1 = require("../../../fromework/abstract/mvvm/AbstractModule");
    ...
    var launch = function(_super) {
      ...
      launch.prototype.clear = function() {};
      launch.prototype.onLoad = function() {};
      launch = __decorate([ AbstractModule_1.Module("launch"), ccclass ], launch);
      return launch;
    }(AbstractModule_1.default);
...
}, {}, [ "Interface", "Observer", "PropertyDecorator", "AbstractModel", "AbstractModule", "AbstractObservable", "AbstractObserverArray", "AbstractView", "AbstractViewModel", "Facade", "Notify", "Update", "UILocalizedAudio", "UILocalizedLabel", "UILocalizedSprite", "UIScrollView", "Company", "ModuleUpdate", "Runtime", "SceneManager", "Utils", "Audio", "Sprite", "Text", "i18n", "common_main", "common", "common_model", "common_view_model", "launch_main", "launch", "launch_model", "launch_view_model" ]);